'use strict';
angular.module('wordCardapp', []).controller('wordCardController', ['$scope', function($scope) {
    var ctrl = this;
    ctrl.configData = {};
    ctrl.languages = [];
     ...
     */
    wordCardService.getLanguages(languageCb);
    ...
    ctrl.nextSetConfig = function() {
        ...
        _.each(ctrl.wordData, function(word) {
            ...
            wordCardService.getTranslation(requestObj, function(err, res) {
                if (!err && res.statusText == "OK") {
     ...
     *   @memberof org.ekstep.wordcard
     *   @returns {void} closed popup
     */
    ...
    /**
     * preparing hard coded json object
     */
    ctrl.wordData = [{
        "identifier": "878",
        "morphology": false,
